                ...
                if (tabsContent.length) {
                    ...
                    tabsContent.forEach(((tabsContentItem, index) => {
                        ...
                        tabsBlock.addEventListener("click", (function() {
                            ...
                            if (!tabsContentItem.hasAttribute("hidden")) tabsContentItem.classList.add("_active-content-tab");
                        }));
                    }));
                }
            }
...
***************************************************************************** */
        ...
        function typeText() {
            ...
            let txt = currTubText;
            let speed = 70;
            for (let i = 0; i < tabsBodies.length; i++) if (tabsBodies[i].classList.contains("_active-content-tab")) activeTabsContentTitle = document.querySelector("._active-content-tab .section__title");
            function typeWriter() {
        ...
        var ball_color = {
            ...
            g: 250,
            b: 215
        }, R = 1.2, balls = [], alpha_f = .01, link_line_width = .5, dis_limit = 300, mouse_ball = {
            x: 0,
            y: 0,
            vx: 0,
            vy: 0,
        ...
        function initBalls(num) {
            for (var i = 1; i <= num; i++) balls.push({
                x: randomSidePos(can_w),
                y: randomSidePos(can_h),
                vx: getRandomSpeed("top")[0],
                vy: getRandomSpeed("top")[1],
        ...
        for (let i = 0; i < swiperBotton.length; i++) swiperBotton[i].addEventListener("click", (e => {
